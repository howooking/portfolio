...
export const PROJECTS: Array<Projects> = [
  ...
  },
  {
    ...
    descs: [
      ...
      "Next API routes를 이용하여 POST요청하고 data를 몽고디비에 저장",
      "Next12에서 13으로의 업그레이드 숙지(본 프로젝트는 12로 제작)",
    ],
    stacks: ["React", "Type-script", "Next-js", "Tailwind-css", "Mongodb"],
  },
  {
  ...
  },
  {
    ...
    descs: [
      ...
      "Prisma, Next API routes, PostgreSQL로 backend 구현",
    ],
    stacks: [
      "React",
      "Type-script",
